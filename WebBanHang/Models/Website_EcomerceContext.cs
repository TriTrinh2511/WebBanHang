...
{
    public partial class Website_EcomerceContext : DbContext
    {
        public Website_EcomerceContext()
        {
        }

        public Website_EcomerceContext(DbContextOptions<Website_EcomerceContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-GVJB3MN\\SQLEXPRESS;Database=Website_Ecomerce;Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.Addressed).HasMaxLength(255);
            ...
            modelBuilder.Entity<TinTuc>(entity =>
            {
                ...
                entity.Property(e => e.Sconntents)
                    .HasMaxLength(255)
                    .HasColumnName("SConntents");
            ...
            modelBuilder.Entity<TransactStatus>(entity =>
            {
                ...
                entity.Property(e => e.Description).HasColumnName("Description_");
